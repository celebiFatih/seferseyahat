...
namespace Sefer_Seyahat
{
    public partial class Form1 : Form
    {
        ...
        SqlConnection baglanti = new SqlConnection(@"Data Source=DESKTOP-2HOS6DT\SQLEXPRESS;Initial Catalog=Test_YolcuBilet;Integrated Security=True");
        ...
        private void btn_Click(object sender, EventArgs e)
        {
            ...
            {
                baglanti.Open();
                SqlCommand komut = new SqlCommand("insert into TBLYOLCUBILGI(AD,SOYADI,TELEFON,TC,CINSIYETI,MAIL) values(@p1,@p2,@p3,@p4,@p5,@p6)", baglanti);
        ...
        private void btnRez_Click(object sender, EventArgs e)
        {
            ...
            if (yolcuDurum == true)//daha once yolcu bilgileri kayıtlı ise bilet aldırır yoksa önce yolcu bilgilerinin kayıt edilmesini ister
            {
        ...
        private void btnSeferBul_Click(object sender, EventArgs e)
        {
            ...
            baglanti.Open();
            SqlCommand komut = new SqlCommand("select * from TBLSEFERBILGI where TARIH="+maskedTextBox1.Text, baglanti);
